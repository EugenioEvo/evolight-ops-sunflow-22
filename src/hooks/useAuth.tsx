...
type AppRole = 'admin' | 'engenharia' | 'supervisao' | 'backoffice' | 'sup_eletromecanico' | 'tecnico_campo' | 'eletromecanico' | 'cliente';
...
const ROLE_PRIORITY: AppRole[] = ['admin', 'engenharia', 'supervisao', 'backoffice', 'sup_eletromecanico', 'tecnico_campo', 'eletromecanico', 'cliente'];
